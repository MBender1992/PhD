...
# statistics
library(rstatix)
# library(EnvStats) for function geoMEan
# Heatmap
...
For easier computation and symmetry around 0 fold changes were calculated using log2 expression values to calculate the log-fold change (log2FC).The analogous threshold to FC > 1.5 is  |log2FC| >  0.585. 
...
Combining the criterea for different expression as described in section 1.4, four miRNAs remained. 

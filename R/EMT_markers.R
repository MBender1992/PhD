...
png("Results/EMT_markers.png", units="in", width=4, height=6, res=600)
...
png("Results/EMT_markers_ratio.png", units="in", width=5, height=4, res=600)
dat_ratio %>%
  ...
  ylab("Ratio (log2) of N-Cadherin/E-Cadherin")+
  geom_hline(yintercept = 0, lty = 1) +
  # scale_y_continuous(guide = "axis_minor", limits = c(-1.6, 2.5), breaks = c(seq(-1.6,2.4, 0.4))) +
